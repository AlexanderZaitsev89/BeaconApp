...
public class AppConfig {
    ...
    // server sends the courses that user is registered to
    public static String URL_SHOW_MY_ENROLLED_COURSES = "http://5.101.107.114:8080/api/getMyCourses ";

    // server sends the courses that user attended
    public static String URL_SHOW_MY_ATTENDECES = "http://5.101.107.114:8080/api/getMyAttendances ";
}
